        ...
        <div className={`group relative transition min-h-[80px] border-[1px] `}>
            <div className='group-hover:flex hidden px-2 rounded w-full h-full items-center'>
                <div
                    ...
                    className='bg-cyan-300 cursor-pointer hover:bg-cyan-400 transition text-center text-white p-1 w-1/2 mx-2 rounded font-bold'>Ins</div>
                <div className='bg-cyan-300 cursor-pointer hover:bg-cyan-400 transition text-center text-white p-1 w-1/2 mx-2 rounded font-bold'>Post</div>
            </div>
